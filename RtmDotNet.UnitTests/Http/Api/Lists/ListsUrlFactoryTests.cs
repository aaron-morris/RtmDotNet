// -----------------------------------------------------------------------
// <copyright file="ListsUrlFactoryTests.cs" author="Aaron Morris">
...
{
    [TestFixture]
    public class ListsUrlFactoryTests
    {
        [Test]
        public void CreateGetListsUrl_ReturnsGetListsUrl()
        {
            ...
            var fakeUrlBuilderFactory = Substitute.For<IListsUrlBuilderFactory>();
        ...
        private ListsUrlFactory GetItemUnderTest(IListsUrlBuilderFactory urlBuilderFactory)
        {
            return new ListsUrlFactory(urlBuilderFactory);
        }
    }
}